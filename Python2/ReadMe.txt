This is the Python 2.7 version of TrelaCalc. It will no longer be improved (as of January 2019) and no new features will be added as a new version for Python 3 is in development. All new features will be only added to the Python 3 version.
