...
Scripts:
Deformation matrices generator - when given a strain value it will calculate the necessary deformation matrices to use in the quantum calculations (VASP).
TrelaCalc-complete - This is the main script that has all the functions of other scripts. From the ab initio results, it will calculate SOEC, TOEC and other properties. 
...
GUI Constant calculator + matrix generator - This creates a simple GUI in which the SOEC and TOEC can be calculated. Also the deformation matrices can be generated in the GUI.
